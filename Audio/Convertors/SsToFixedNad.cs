...
namespace MusGen
{
	public static class SsToFixedNad
	{
		public static Nad Make(SS ss, bool comparison)
		{
			ProgressShower.Show("Ss to FixedNad...");
		...
		public static NadSample MakeSample(float[] spectrum)
		{
			...
			ns._indexes = PeaksFinding.PeaksFinder.Find(spectrum, AP._channels, AP._peakWidth_ForFixedNad);
