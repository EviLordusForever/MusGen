...
namespace MusGen
{
	public static class WAV_FNAD_WAV_exp
	{
		public static void Make(string wavInPath, string exportName, float speed, float pitch)
		{
			...
			wavOut.Export(exportName + " (WAV_FNAD_WAV)");

			Logger.Log($"WAV_FNAD_WAV_exp finished. Saved as ({exportName})");
		}
	}
}
